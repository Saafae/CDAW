...
<body>
    ...
    <div style="display:flex;flex-direction:column;justify-content:center;align-items:center;margin-top:50px; text-align : center">
        ...
        <div class="card" style="width: 18rem;">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Categorie :  {{$cat=App\Models\category::where('id',$infos->category_id)->first()->name}}</p>
            </div>
        </div>
    </div>
</body>
